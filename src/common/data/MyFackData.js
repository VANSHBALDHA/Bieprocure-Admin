...
const legalContentPages = [
  ...
  {
    id: 3,
    pageName: "Refund & Replacement Policy",
    slug: "refund-replacement-policy",
    content:
      "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.",
    status: "Active",
  },
...
const mediaUploadData = [
  {
    id: 1,
    file: "https://media.istockphoto.com/id/1372577388/photo/old-electronic-devices-on-a-dark-background-the-concept-of-recycling-and-disposal-of.jpg?s=612x612&w=0&k=20&c=RGm3eCA76Y_IJJYGCLWS9acSR39Gb7iqsC_DIhJyG2g=",
  },
  {
    id: 2,
    file: "https://media.istockphoto.com/id/1372577388/photo/old-electronic-devices-on-a-dark-background-the-concept-of-recycling-and-disposal-of.jpg?s=612x612&w=0&k=20&c=RGm3eCA76Y_IJJYGCLWS9acSR39Gb7iqsC_DIhJyG2g=",
...
const ordersData = [
  {
    orderId: "O-10234-20250331",
    customer: {
      name: "ABC Corporation",
      id: "#123",
      quotedUser: "Animesh Soni (Sales Team)",
      cartUser: "Ankit Gandhi (Purchase Team)",
      communication: {
        email: "abc@xyz.com",
        phone: "7778889994",
      },
    ...
    orderDetails: {
      orderedDate: "01-05-2025",
      partShipment: "Allowed",
      status: "Partially Delivered",
      deliveryScheduled: "8–10 Weeks",
      lastMonth: "Jun-2025",
      purchaseOrder: {
        type: "Uploaded By Customer",
        uploadedBy: "Ankit Gandhi",
        downloadLink: "#download-po.pdf",
        uploadedOn: "31-Mar-2025, 04:45 PM",
      },
      paymentTerms: {
        type: "Modified & Verified",
        verifiedBy: "Rajesh Mehta",
      },
    },
    billingAddress: {
      fullName: "ABC Corp Billing",
      contactNumber: "7778889994",
      pincode: "123456",
      addressLine1: "Flat 101, Tech Towers",
      addressLine2: "MG Road",
      landmark: "Near Central Mall",
      cityState: "Ahmedabad, Gujarat",
    },
    shippingAddress: {
      fullName: "ABC Corp Shipping",
      contactNumber: "7778889994",
      pincode: "123456",
      addressLine1: "Flat 102, Sky Heights",
    ...
    invoiceData: [
      ...
      {
        piNumber: "O-10235-20250402/001/PRO-2",
        piCreatedDate: null, // PI not created yet
        invoiceNumber: null,
        invoiceCreatedDate: null,
        qty: 150,
        billAmount: 190000.0,
        receivedAmount: 19000.0,
      },
    ],
    paymentTermsBreakdown: [
      ...
      },
      {
        ...
        receivedAmount: 0,
        invoiceCreated: true,
        invoiceDate: "03-Apr-2025",
      },
    ],
  },
  {
    orderId: "O-20234-20250401",
    customer: {
      name: "XYZ Pvt Ltd",
      id: "#456",
      quotedUser: "Rahul Sharma (Sales Team)",
      cartUser: "Neha Desai (Purchase Team)",
      communication: {
        email: "xyz@abc.com",
        phone: "8888777766",
      },
    ...
    orderDetails: {
      ...
      deliveryScheduled: "6–8 Weeks",
      lastMonth: "Jul-2025",
      purchaseOrder: {
        type: "System Generated",
        downloadLink: "#download-po-system.pdf",
        uploadedOn: "01-Apr-2025, 10:15 AM",
      },
      paymentTerms: {
        type: "System Defined",
      },
    ...
    billingAddress: {
      fullName: "XYZ Billing",
      contactNumber: "8888777766",
      pincode: "654321",
      addressLine1: "A-202, Business Bay",
      addressLine2: "Ring Road",
      landmark: "Next to Metro Station",
      cityState: "Surat, Gujarat",
    },
    shippingAddress: {
      fullName: "XYZ Shipping",
      contactNumber: "8888777766",
      pincode: "654321",
      addressLine1: "B-303, Industrial Park",
      addressLine2: "Udhna Road",
      landmark: "Opp. Textile Market",
      cityState: "Surat, Gujarat",
    },
    products: [
      {
    ...
    summary: {
      ...
      gst: 25200,
      total: 165200,
      advanceReceived: 16520,
    },
    quantities: {
      totalOrderedQty: 1500,
    ...
    invoiceData: [
      {
        piNumber: "O-10234-20250402/001/PRO-1",
        piCreatedDate: "02-Apr-2025",
        invoiceNumber: "O-10234-20250430/001/INV-1",
        invoiceCreatedDate: "30-Apr-2025",
        qty: 3000,
        billAmount: "3,30,400.00",
        receivedAmount: "32,400.00",
      },
    ],
    paymentTermsBreakdown: [
      {
